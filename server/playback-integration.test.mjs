...
try {
  ...
  console.log(JSON.stringify({ result: "passed", tested: ["Range", "dual copy", "shared pipeline", "session reuse", "live HLS sliding", "fixed TARGETDURATION", "HLS EOF", "seek PTS", "stale generation", "audio switching", "DTS audio-only", "full transcode", "release accounting"], elapsedMs: Math.round(performance.now() - start), status }));
